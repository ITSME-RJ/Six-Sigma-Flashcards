const CACHE='six-sigma-v2-1';
const ASSETS=['./','./index.html','./styles.css','./app.js','./cards1.js','./cards2.js','./cards3.js','./cards4.js','./manifest.json','./icons/icon-180.png','./icons/icon-192.png','./icons/icon-512.png'];
